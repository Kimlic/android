...
import com.kimlic.documents.fragments.PortraitPhotoFragment_
...
class DocumentVerifyActivity_test : BaseActivity() {
    ...
    private fun setupUI() {
        documentType = "PASSPORT"//intent.extras.getString(AppConstants.DOCUMENT_TYPE.key, "")
        country = "Ukraine"//intent.extras.getString(AppConstants.COUNTRY.key, "")
        ...
        frontFragment.setCallback(object : PhotoCallback {
            override fun callback(data: ByteArray) {
                ...
                if (documentType == AppDoc.PASSPORT.type) {
                    ...
                    PresentationManager.detailsDocumentSave(this@DocumentVerifyActivity_test, documentType, country, DOCUMENT_TAKE_PHOTO_REQUEST_CODE)
                } else {
    ...
    private fun initFragments() {
        ...
        portraitFragment = PortraitPhotoFragment_.newInstance(portraitBundle)
