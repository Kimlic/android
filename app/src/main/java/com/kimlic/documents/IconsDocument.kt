...
enum class IconsDocument(val icon: Int) {
    ...
    ID_BLUE(R.drawable.ic_id_card_blue),
    ...
    SOCIAL_SECURITY_CARD_BLUE(R.drawable.ic_social_securty_card_blue),
    SOCIAL_SECURITY_CARD_WHITE(R.drawable.ic_social_securty_card_white),

    BIRTH_CERTIFICATE_BLUE(R.drawable.ic_stroller_blue),
    BIRTH_CERTIFICATE_WHITE(R.drawable.ic_stroller_white),
}