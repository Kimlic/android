...
import com.kimlic.R
import com.kimlic.camera.CameraBaseFragment_
import com.kimlic.utils.AppConstants
import kotlinx.android.synthetic.main.fragment_document_portrait.*

class PortraitPhotoFragment_ : CameraBaseFragment_() {
    ...
    companion object {
        ...
        fun newInstance(bundle: Bundle = Bundle()): PortraitPhotoFragment_ {
            val fragment = PortraitPhotoFragment_()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_document_portrait_, container, false)
    }
