...
class UserStageFragment_new : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(bundle: Bundle = Bundle()): UserStageFragment_new {
            val fragment = UserStageFragment_new()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_stage_user_new, container, false)
    }
...
//internal enum class Icons_new(val icon: Int) {
//
