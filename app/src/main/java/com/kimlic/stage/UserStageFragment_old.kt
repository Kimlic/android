...
//import java.io.File
//
//class UserStageFragment_old : BaseFragment(), LifecycleObserver {
//
//    // Companion
//
//    companion object {
...
//
//        fun newInstance(bundle: Bundle = Bundle()): UserStageFragment_old {
//            val fragment = UserStageFragment_old()
...
//        model.userLive().observe(this@UserStageFragment_old, Observer<User> { user ->
//            user?.let {
//                setupNameField(
//                        if (it.firstName.isNotEmpty()) {
//                            "${it.firstName} ${it.lastName}"
//                        } else ""
//                        , model.hasDocumentInProgress())// TODO refactor
...
//        })
//
//        model.userDocumentsLive().observe(this@UserStageFragment_old, Observer<List<Document>> { documents -> documentsAdapter.setDocumentsList(documents!!) })
//    }
//
...
//        kimItem.arrowIv.visibility = View.GONE
//        kimItem.contentTv.text = Editable.Factory.getInstance().newEditable(getString(R.string.balance, kim))
...
//    }
//
//    private fun setupNameField(name: String = "", hasDocsInProgress: Boolean) {
//        nameArrow.background = resources.getDrawable(if (name == "") Icons_.ARROW_BLUE.icon else Icons_.ARROW_WHITE.icon, null)
//        nameArrow.visibility = if (hasDocsInProgress) View.GONE else View.VISIBLE
